...
function InputField({unit, amount, errorMessage = '', error = false, disabled, dimensions = {longueur : '', largeur : '', hauteur : '', ratio : ''}, listUnit, needTab = {longueur : false, largeur : false, hauteur : false, ratio : false, helper : ''}, handleUnitChange, handleAmountChange, setErrorMessage = () => {}, setDimensions = () => {}} : InputFieldProps) {
