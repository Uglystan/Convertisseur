...
class ConverterClass {
	...
	constructor(montant : number, inputUnit : string, outputUnit : string, dimensions? : Dimensions) {
		...
		if (dimensions?.ratio !== undefined && dimensions.ratio < 0)
	...
	private convertHMtoBARRE() : string {
		if (this.dimensions?.longueur === undefined)
	...
	private convertM2toLAMEPANNEAUROULEAU () : string {
		if (this.dimensions?.longueur === undefined || this.dimensions?.largeur === undefined)
	...
	private convertM3toBARRE () : string {
		if (this.dimensions?.longueur === undefined || this.dimensions?.largeur === undefined || this.dimensions?.hauteur === undefined)
	...
	private convertKGtoM2 () : string {
		if (this.dimensions?.ratio === undefined)
			throw Error("Ratio Kg/M2 manquant pour la conversion")
		return this.convertSimpleTemplate(this.dimensions.ratio)
	}
	...
	private convertM2toM3 () : string {
		if (this.dimensions?.hauteur === undefined)
	...
	private convertM2toM () : string {
		if (this.dimensions?.largeur === undefined)
	...
	private convertM3toM () : string {
		if (this.dimensions?.largeur === undefined || this.dimensions?.hauteur === undefined)
	...
	private convertSAC25KGtoM2 () : string {
		if (this.dimensions?.ratio === undefined)
			throw Error("Ratio KG/M2 manquant pour la conversion")
		const pricePerM2 = (this.montant / 25) * this.dimensions.ratio
