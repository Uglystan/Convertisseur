...
class Converter {
	...
	constructor(montant : number, inputUnit : string, outputUnit : string, dimensions? : Dimensions, ratio? : number) {
		...
		this.convertTab = {
			...
			"L to M2" : this.convertLtoM2.bind(this),
			"M2 to M3" : this.convertM2toM3.bind(this),
			"M2 to M" : this.convertM2toM.bind(this),
			"M3 to M" : this.convertM3toM.bind(this),
			"PALETTE de 15 BARRE to M" : this.convertPALETTE15BARREtoM.bind(this),
			"ROULEAU to M2" : this.convertROULEAUtoM2.bind(this),
			"U to M" : this.convertUtoM.bind(this),
			"X50 to M" : this.convertX50toM.bind(this),
			"SAC de 25KG to M2" : this.convertSAC25KGtoM2.bind(this),
		}
	}
